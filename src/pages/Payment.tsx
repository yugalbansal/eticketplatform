...
//   const navigate = useNavigate();
//   const { events } = useEventStore();
//   const { isAuthenticated, addTicket } = useAuthStore();
//   const [selectedTicket, setSelectedTicket] = useState('general');
//   const [quantity, setQuantity] = useState(1);
...
//     addTicket(newTicket);
//     toast.success('🎟️ Ticket generated successfully!');
...
//                 <button onClick={generateTicket} className="w-full py-3 px-4 text-white bg-indigo-600 hover:bg-indigo-700">
//                   Pay with Telos
//                 </button>
//                 <button onClick={generateTicket} className="w-full py-3 px-4 text-gray-700 bg-white border border-gray-300 hover:bg-gray-50">
//                   Pay with Razorpay
//                 </button>
//               </div>
//             </div>
    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
          ...
          {ticketData && (
            <div className="bg-green-50 p-6 mt-6 rounded-lg shadow-md">
              <h3 className="text-xl font-bold text-green-700">🎟️ Ticket Confirmation</h3>
              <p className="text-gray-600 mt-2">Here are your ticket details:</p>
              <div className="mt-4 space-y-2 text-sm text-gray-800">
                <div className="flex justify-between"><strong>Event:</strong> {ticketData.event.title}</div>
                <div className="flex justify-between"><strong>Date & Time:</strong> {ticketData.event.date} at {ticketData.event.time}</div>
                <div className="flex justify-between"><strong>Venue:</strong> {ticketData.event.venue}</div>
                <div className="flex justify-between"><strong>Ticket Type:</strong> {ticketData.type}</div>
                <div className="flex justify-between"><strong>Quantity:</strong> {ticketData.quantity}</div>
                <div className="flex justify-between"><strong>Total Amount:</strong> ${ticketData.totalPrice}</div>
              </div>
            </div>
          )}
        </div>
